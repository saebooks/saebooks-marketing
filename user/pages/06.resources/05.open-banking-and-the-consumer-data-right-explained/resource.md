---
title: 'Open Banking and the Consumer Data Right Explained'
date: '2026-06-29 00:12'
template: resource
category: 'Guide'
hero: '/user/data/article-visuals/open-banking-and-the-consumer-data-right-explained-hero.svg'
read_time: '~2 min read'
dek: 'Learn how Australia''s Consumer Data Right enables open banking via secure APIs, what accreditation means, and how CDR bank feeds work in SAE Books.'
metadata:
    description: 'Learn how Australia''s Consumer Data Right enables open banking via secure APIs, what accreditation means, and how CDR bank feeds work in SAE Books.'
taxonomy:
    category: [resources]
    tag: ['open banking', 'consumer data right', 'cdr', 'bank feeds', 'accc', 'small business accounting']
sources:
