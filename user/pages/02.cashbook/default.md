...
<section class="band" id="why-cashbook">
  <div class="container">
    <div class="sh">
    ...
    <div class="three-up">
      <div class="point">
        <div class="icon">
          <svg class="lucide" viewBox="0 0 24 24" style="width:22px;height:22px;"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
        </div>
        <h3>Free for life</h3>
        <p>Not a trial. Not a &ldquo;free tier&rdquo; that disappears when you hit some limit. Cashbook is AGPLv3 open-source software. Install it on your own server and it stays free for as long as you run it &mdash; no vendor, no subscription, no gotcha.</p>
      </div>
      <div class="point">
        <div class="icon">
        ...
        <p>Your books live in a database you control, on hardware you own or rent. No cloud vendor can raise prices on you, no service can be discontinued under you, and no one can sell your transaction data to a third party. Cancel nothing &mdash; just stop running the container.</p>
      </div>
      <div class="point">
        <div class="icon">
...
<section class="subtle" id="upgrade-arc">
  <div class="container">
    <div class="sh">
