...
<section>
  <div class="container">
    ...
    <div class="feature-grid">
      ...
      <div class="tile"><div class="icon"><svg class="lucide" viewBox="0 0 24 24"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg></div><h4>GST / BAS report generation</h4><p>AU-standard BAS labels, built in. Generate, review, lodge via the ATO portal.</p></div>
