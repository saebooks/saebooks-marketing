  ...
  <div class="container">
    <div class="hero-grid">
      <div>
        ...
        <div class="hero-meta">
          <span class="pill"><span class="dot"></span>Free Cashbook &mdash; on your device</span>
...
<section class="band" id="editions">
  <div class="container">
    <div class="sh">
      ...
      <p>Two ways to start free: Cashbook on your device for sole traders, or self-hosted Community for the full double-entry stack. Same codebase, runtime-flagged for what you need. Paid tiers are self-hosted by default.</p>
    </div>
    <div class="tiers-wrap">
      <div class="tiers-grid">
        ...
        <div class="tier">
          ...
          <div class="tier-foot">On your device. Australian-owned, AGPLv3 codebase.</div>
        </div>
